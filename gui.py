...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.formLayoutWidget_2.setGeometry(QtCore.QRect(240, 20, 171, 201))
        ...
        self.formLayoutWidget_3.setGeometry(QtCore.QRect(470, 30, 171, 191))
        self.formLayoutWidget_3.setObjectName("formLayoutWidget_3")
        self.formLayoutDisk = QtWidgets.QFormLayout(self.formLayoutWidget_3)
        self.formLayoutDisk.setSizeConstraint(QtWidgets.QLayout.SetMinAndMaxSize)
        ...
        self.widget.setGeometry(QtCore.QRect(350, 730, 351, 31))
        self.widget.setObjectName("widget")
        self.horizontalLayout = QtWidgets.QHBoxLayout(self.widget)
        self.horizontalLayout.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.StartLogging = QtWidgets.QPushButton(self.widget)
        self.StartLogging.setObjectName("StartLogging")
        self.horizontalLayout.addWidget(self.StartLogging)
        self.EndLogging = QtWidgets.QPushButton(self.widget)
